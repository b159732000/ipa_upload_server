...
app.use('/public', express.static('public'));   // 靜態文件
app.use(cors());        // 跨域
...
const auth = require('./routes/auth');      // 實際處理登入驗證的邏輯(route)
...
// app.use('/mern_users', mern_usersRouter);
...
var server = app.listen(port, function () {
    ...
    // 下面兩行的寫法都OK
    // console.log('此伺服器所在位置為 http://%s:%s', host, port);
